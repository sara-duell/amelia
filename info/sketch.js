...
function setup() {
  ...
  topLayer.image(img01, 0, 0, displayWidth, displayHeight, 0, 0, displayWidth, 1667, CONTAIN)
...
function draw() {
  image(img02, 0, 0, displayWidth, displayHeight, 0, 0, displayWidth, 1667, CONTAIN);
