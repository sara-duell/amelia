...
function setup() {
  ...
  topLayer.image(img01, 0, 0, displayWidth, displayHeight, 0, 0, window.innerWidth, window.innerHeight, COVER)
...
function draw() {
  image(img02, 0, 0, displayWidth, displayHeight, 0, 0, window.innerWidth, window.innerHeight, COVER);
