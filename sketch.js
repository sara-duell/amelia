...
function setup() {
  ...
  topLayer.image(img01, 0, 0, displayWidth, displayHeight, 0, 0, 2500, displayHeight, COVER)
...
function draw() {
  image(img02, 0, 0, displayWidth, displayHeight, 0, 0, 2500, displayHeight, COVER);
